...
namespace JSIL.Compiler.Extensibility.DeadCodeAnalyzer {
    public class DeadCodeInfoProvider {
        ...
        private readonly DeadCodeAnalyzerConfiguration configuration;
        private readonly List<Regex> whiteListCache;

        public DeadCodeInfoProvider(DeadCodeAnalyzerConfiguration configuration)
        {
            ...
            // ------------ REMOVED SECOND CONDITION INSIDE "if" BY USERWARE ------------
