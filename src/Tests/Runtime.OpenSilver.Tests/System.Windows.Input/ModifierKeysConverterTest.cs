...
[TestClass]
public sealed class ModifierKeysConverterTest : TypeConverterTestBase
{
    protected override TypeConverter Converter { get; } = new ModifierKeysConverter();
    ...
    public static IEnumerable<object[]> ConvertFrom_TestData()
    {
        ...
        yield return new object[] { "Apple", ModifierKeys.Apple };
