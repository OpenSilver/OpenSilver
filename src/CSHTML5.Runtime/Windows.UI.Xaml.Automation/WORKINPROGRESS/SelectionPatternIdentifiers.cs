...
#endif
{
	...
	public static partial class SelectionPatternIdentifiers
	{
		//
		// Summary:
		//     Identifies the System.Windows.Automation.Provider.ISelectionProvider.CanSelectMultiple
		//     automation property.
		//
		// Returns:
		...
		//
		// Summary:
		//     Identifies the System.Windows.Automation.Provider.ISelectionProvider.IsSelectionRequired
		//     automation property.
		//
		// Returns:
		//     The automation property identifier.
