...
{
    /// <summary>A set of functions for data conversion operations.</summary>
    internal static class ValueHelper
    {
        /// <summary>The value of a single radian.</summary>
        ...
        /// <summary>Attempts to convert an object into a double.</summary>
        ...
        public static bool TryConvert(object value, out double doubleValue)
        {
            ...
            try
            {
                if (value != null && (value is double || value is int || (value is byte || value is short) || (value is Decimal || value is float || (value is long || value is uint)) || (value is sbyte || value is ushort) || value is ulong))
                {
        ...
        /// <summary>Attempts to convert an object into a date time.</summary>
        /// <param name="value">The value to convert.</param>
        ...
        /// <summary>Converts an object into a double.</summary>
        ...
        /// <summary>Converts a value to a date.</summary>
        ...
        public static IEnumerable<DateTime> GetDateTimesBetweenInclusive(DateTime start, DateTime end, long count)
        {
            ...
            return ValueHelper.GetIntervalsInclusive(start.Ticks, end.Ticks, count).Select<long, DateTime>((Func<long, DateTime>)(value => new DateTime(value)));
        }
        ...
        {
            Debug.Assert(count >= 2L, "Count must be at least 2.");
            return ValueHelper.GetIntervalsInclusive(0L, timeSpan.Ticks, count).Select<long, TimeSpan>((Func<long, TimeSpan>)(value => new TimeSpan(value)));
        }
        ...
        /// <summary>Removes the noise from double math.</summary>
        ...
        internal static double RemoveNoiseFromDoubleMath(double value)
        {
            ...
            return double.Parse(value.ToString((IFormatProvider)CultureInfo.InvariantCulture), (IFormatProvider)CultureInfo.InvariantCulture);
        }

        /// <summary>Converts a range into a double range.</summary>
        ...
        /// <summary>Converts a range into a date time range.</summary>
        /// <param name="range">The range to convert.</param>
        /// <returns>A range with its members converted to date times.</returns>
        ...
        /// <summary>Applies the translate transform to a point.</summary>
        ...
        /// <summary>Converts any range to a range of IComparable.</summary>
        ...
        {
            if (range.HasData)
                return new Range<IComparable>((IComparable)range.Minimum, (IComparable)range.Maximum);
            return new Range<IComparable>();
        }

        /// <summary>Returns the left value of the rectangle.</summary>
        ...
        /// <summary>Returns the right value of the rectangle.</summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <param name="value">The default value.</param>
        ...
        /// <summary>Returns the width value of the rectangle.</summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <param name="value">The default value.</param>
        ...
        /// <summary>Returns the height value of the rectangle.</summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <param name="value">The default value.</param>
        ...
        /// <summary>Returns the bottom value of the rectangle.</summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <param name="value">The default value.</param>
        ...
        /// <summary>Returns the top value of the rectangle.</summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <param name="value">The default value.</param>
        ...
        /// <summary>Returns the time span of a date range.</summary>
        ...
        {
            return range.HasData ? new TimeSpan?(range.Maximum - range.Minimum) : new TimeSpan?();
        }
        ...
        {
            return range.HasData ? new double?(range.Maximum - range.Minimum) : new double?();
        }
        ...
        {
            return rect.IsEmpty || rect.Width == 0.0 && rect.Height == 0.0;
        }

        /// <summary>Sets the style property of an element.</summary>
