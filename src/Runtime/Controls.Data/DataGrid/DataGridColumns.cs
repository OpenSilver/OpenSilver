...
namespace System.Windows.Controls
{
    public partial class DataGrid
    {
        ...
        private static DataGridAutoGeneratingColumnEventArgs GenerateColumn(Type propertyType, string propertyName, string header, object descriptor)
        {
            ...
            return new DataGridAutoGeneratingColumnEventArgs(newColumn, propertyName, propertyType, descriptor);
        }
        ...
        private void GenerateColumnsFromProperties()
        {
            ...
            if (this.DataConnection.DataProperties != null && this.DataConnection.DataProperties.Length > 0)
            {
                ...
                foreach (PropertyInfo propertyInfo in this.DataConnection.DataProperties)
                {
                    ...
                    DataGridAutoGeneratingColumnEventArgs columnArgs = GenerateColumn(propertyInfo.PropertyType, propertyInfo.Name, columnHeader, propertyInfo);
            ...
            {
                AddGeneratedColumn(GenerateColumn(this.DataConnection.DataType, string.Empty, this.DataConnection.DataType.Name, null));
            }
        }
