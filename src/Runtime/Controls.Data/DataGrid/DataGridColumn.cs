...
#region Public Properties
        ...
        /// </summary>
        /// <returns>
        /// The style that is used when rendering the column header, or null to use the <see cref="DataGrid.ColumnHeaderStyle"/> setting.
        /// The default is null.
        /// </returns>
        ...
        /// When setting this property to false on a column derived from <see cref="DataGridBoundColumn"/>, the column 
        /// <see cref="DataGridBoundColumn.Binding"/> property indicates a data source that is read-only.-or-When setting 
        /// this property to true on a column with a cell that is in edit mode, the cell edit cannot be committed or reverted.
        /// </exception>
        ...
        /// </summary>
        /// <returns>
        /// The maximum column width in pixels. The default is <see cref="double.PositiveInfinity"/>.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        /// When setting this property, the specified value is less than 0.-or-The specified value is less than the 
        /// <see cref="MinWidth"/>.-or-The specified value is less than the <see cref="DataGrid.MinColumnWidth"/>
        /// and the <see cref="MinWidth"/> is not set.
        /// </exception>
        ...
        /// <see cref="MaxWidth"/>.-or-The specified value is greater than the <see cref="DataGrid.MaxColumnWidth"/>
        /// and the <see cref="MaxWidth"/> is not set.
        /// </exception>
        /// <exception cref="ArgumentException">
        /// The specified value is <see cref="double.NaN"/>.-or-The specified value is <see cref="double.PositiveInfinity"/>.
        /// </exception>
        ...
        /// </summary>
        /// <returns>
        /// An enumeration value that specifies the column visibility. The default is <see cref="Visibility.Visible"/>.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// A structure that represents the column width or an automatic sizing mode. The default is the <see cref="DataGrid.ColumnWidth"/> property value.
        /// </returns>
...
#region Internal Properties
        ...
        /// <summary>
        /// Gets the <see cref="ContentControl.Content"/> property value for the cell at the intersection of this column and the
        /// specified row.
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="InvalidOperationException">
        /// This column has not been added to a <see cref="DataGrid"/>.
        /// </exception>
        ...
        /// <summary>
        /// Gets the <see cref="ContentControl.Content"/> property value for the cell at the intersection of this column and the row 
        /// that represents the specified data item.
        /// </summary>
        /// <param name="dataItem">
