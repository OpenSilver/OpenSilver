...
namespace System.Windows.Controls
{
    ...
    public partial class Calendar : Control
    {
        ...
        private static void OnDisplayModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!CalendarExtensions.IsHandlerSuspended(c, Calendar.DisplayModeProperty))
            {
                ...
                {
                    CalendarExtensions.SetValueNoCallback(c, Calendar.DisplayModeProperty, e.OldValue);
                    throw new ArgumentOutOfRangeException(nameof(d), Resource.Calendar_OnDisplayModePropertyChanged_InvalidValue);
                }
            }
        }
        ...
        private static void OnFirstDayOfWeekChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(d), Resource.Calendar_OnFirstDayOfWeekChanged_InvalidValue);
            }
        }
        ...
        private static void OnSelectionModeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                CalendarExtensions.SetValueNoCallback(c, Calendar.SelectedDateProperty, null);
                c.SelectedDates.Clear();
            }
            else
            {
                throw new ArgumentOutOfRangeException(nameof(d), Resource.Calendar_OnSelectionModeChanged_InvalidValue);
            }
        }
        ...
        private static void OnSelectedDateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!CalendarExtensions.IsHandlerSuspended(c, Calendar.SelectedDateProperty))
            {
                if (c.SelectionMode != CalendarSelectionMode.None)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(nameof(d), Resource.Calendar_OnSelectedDateChanged_InvalidValue);
                    }
                }
                else
                {
        ...
        private static void OnDisplayDateStartChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!CalendarExtensions.IsHandlerSuspended(c, Calendar.DisplayDateStartProperty))
            {
        ...
        private static void OnDisplayDateEndChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!CalendarExtensions.IsHandlerSuspended(c, Calendar.DisplayDateEndProperty))
            {
                DateTime? newValue = e.NewValue as DateTime?;
        ...
        internal static bool IsValidDateSelection(Calendar cal, object value)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        CalendarExtensions.SetValueNoCallback(cal, Calendar.DisplayDateStartProperty, value);
                    }
                    else if (DateTime.Compare((DateTime) value, cal.DisplayDateRangeEnd) > 0)
                    {
                        CalendarExtensions.SetValueNoCallback(cal, Calendar.DisplayDateEndProperty, value);
                    }
                    return true;
                }
            }
