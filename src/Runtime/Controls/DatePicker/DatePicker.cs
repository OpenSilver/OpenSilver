...
namespace System.Windows.Controls
{
    ...
    public partial class DatePicker : Control
    {
        ...
        private static void OnSelectedDateFormatChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(d), Resource.DatePicker_OnSelectedDateFormatChanged_InvalidValue);
            }
        }
        ...
        private static void OnTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!CalendarExtensions.IsHandlerSuspended(dp, DatePicker.TextProperty))
            {
                ...
                else
                {
                    if (!dp._settingSelectedDate)
                    {
                        CalendarExtensions.SetValueNoCallback(dp, DatePicker.SelectedDateProperty, null);
                    }
                }
            }
            else
        ...
        private DateTime? ParseText(string text)
        {
            ...
            try
            {
                ...
                {
                    DatePickerDateValidationErrorEventArgs dateValidationError = new DatePickerDateValidationErrorEventArgs(new ArgumentOutOfRangeException(nameof(text), Resource.Calendar_OnSelectedDateChanged_InvalidValue), text);
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (this._textBox != null)
            {
                CalendarExtensions.SetValueNoCallback(this, DatePicker.TextProperty, this._textBox.Text);
            }
        }
