    ...
    public class TreeView : ItemsControl, IUpdateVisualState
    {
        ...
        private static void OnSelectedItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowWrite)
            {
                ...
                throw new InvalidOperationException(
                    Resource.TreeView_OnSelectedItemPropertyChanged_InvalidWrite);
            }
        ...
        private static void OnSelectedValuePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowWrite)
            {
                ...
                throw new InvalidOperationException(
                    Resource.TreeView_OnSelectedValuePropertyChanged_InvalidWrite);
            }
        }
        ...
        private bool HandleScrollByPage(bool up)
        {
            ...
            if (scrollHost != null)
            {
                ...
                double top;
                double bottom;
                ScrollExtensions.GetTopAndBottom(SelectedContainer.HeaderElement ?? SelectedContainer, scrollHost, out top, out bottom);
