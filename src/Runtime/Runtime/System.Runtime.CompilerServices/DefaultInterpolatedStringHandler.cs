...
namespace System.Runtime.CompilerServices
{
    ...
    internal ref struct DefaultInterpolatedStringHandler
    {
        ...
        {
            if (StringExtensions.TryCopyTo(value, _chars.Slice(_pos)))
            {
                _pos += value.Length;
            }
            else
        ...
        public void AppendFormatted(string? value)
        {
            ...
            if (!_hasCustomFormatter &&
                value is not null &&
                StringExtensions.TryCopyTo(value, _chars.Slice(_pos)))
            {
                _pos += value.Length;
            }
            else
        ...
        private void AppendFormattedSlow(string? value)
        {
            ...
            else if (value is not null)
            {
                ...
                StringExtensions.CopyTo(value, _chars.Slice(_pos));
                _pos += value.Length;
            }
        }
        ...
        private void GrowCore(uint requiredMinCapacity)
        {
            ...
            uint newCapacity = Math.Max(requiredMinCapacity, Math.Min((uint)_chars.Length * 2, StringExtensions.MaxLength));
            int arraySize = (int)MathExtensions.Clamp(newCapacity, MinimumArrayPoolLength, int.MaxValue);
        ...
        private static class StringExtensions
        {
            ...
            public static bool TryCopyTo(string s, Span<char> destination)
            {
                return s.AsSpan().TryCopyTo(destination);
            }

            public static void CopyTo(string s, Span<char> destination)
            {
