...
/// <summary>
/// Used to arrange overflow <see cref="ToolBar"/> items.
/// </summary>
public class ToolBarOverflowPanel : Panel
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ToolBarOverflowPanel"/> class.
    /// </summary>
    public ToolBarOverflowPanel() { }

    #region Properties
    /// <summary>
    /// Identifies the <see cref="WrapWidth"/> dependency property.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the recommended width for an overflow <see cref="ToolBar"/> before items flow to 
    /// the next line.
    /// </summary>
    /// <returns>
    /// A double value that represents the recommended width of the <see cref="ToolBar"/>.
    /// </returns>
    public double WrapWidth
    {
        get => (double)GetValue(WrapWidthProperty);
        set => SetValueInternal(WrapWidthProperty, value);
    }
    ...
    /// <summary>
    /// Remeasures the <see cref="ToolBarOverflowPanel"/>.
    /// </summary>
    ...
    /// <summary>
    /// Arranges and sizes the content of a <see cref="ToolBarOverflowPanel"/> object.
    /// </summary>
    /// <param name="arrangeBounds">
    /// Size that a toolbar overflow panel assumes to position child elements.
    /// </param>
    /// <returns>
    /// The size of the <see cref="ToolBarOverflowPanel"/>.
    /// </returns>
