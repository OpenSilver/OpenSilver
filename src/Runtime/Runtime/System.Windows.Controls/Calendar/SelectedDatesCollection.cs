...
{
    /// <summary>
    /// Represents a set of selected dates in a <see cref="Calendar" />.
    /// </summary>
    ...
    public sealed class SelectedDatesCollection : ObservableCollection<DateTime>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectedDatesCollection" /> class.
        /// </summary>
        /// <param name="owner">
        /// The <see cref="Calendar" /> associated with this object.
        /// </param>
