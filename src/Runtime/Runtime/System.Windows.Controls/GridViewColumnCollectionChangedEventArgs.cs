...
/// </summary>
internal sealed class GridViewColumnCollectionChangedEventArgs : NotifyCollectionChangedEventArgs
{
    /// <summary>
    ...
    internal GridViewColumnCollectionChangedEventArgs(NotifyCollectionChangedAction action, GridViewColumn[] clearedColumns)
        : base(action)
    {
        ClearedColumns = Array.AsReadOnly(clearedColumns);
    }
    ...
    /// </summary>
    internal int ActualIndex { get; } = -1;

    /// <summary>
    /// Columns removed in reset action.
    /// </summary>
    internal ReadOnlyCollection<GridViewColumn> ClearedColumns { get; }
