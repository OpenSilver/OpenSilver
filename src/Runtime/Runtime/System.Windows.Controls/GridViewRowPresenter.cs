...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GridViewRowPresenter"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Returns a string representation of the <see cref="Content"/>.
    /// </summary>
    /// <returns>
    /// A string that shows the <see cref="Content"/>.
    /// </returns>
    public override string ToString()
    {
        return string.Format(Strings.ToStringFormatString_GridViewRowPresenter,
            GetType(),
    ...
    public object Content
    {
        ...
        set { SetValueInternal(GridViewRowPresenter.ContentProperty, value); }
    }
    ...
    /// The maximum area to use to display the <see cref="Content"/>.
    /// </param>
    /// <returns>
    /// The actual <see cref="Size"/> of the area that displays the <see cref="Content"/>.
    /// </returns>
    ...
    /// <summary>
    /// Positions the content of a row according to the size of the corresponding <see cref="GridViewColumn"/> 
    /// objects.
    /// </summary>
    /// <param name="arrangeSize">
    /// The area to use to display the <see cref="Content"/>.
    /// </param>
    /// <returns>
    /// The actual <see cref="Size"/> that is used to display the <see cref="Content"/>.
    /// </returns>
            ...
            if (itemsControl != null)
            {
                ...
                if (scrollViewer != null)
                {
                        ...
                        scrollViewer.CanContentScroll)
                    {
                        ...
                        _viewPort = scrollViewer.ElementScrollContentPresenter;
