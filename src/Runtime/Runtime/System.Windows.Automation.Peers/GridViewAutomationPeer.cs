...
/// <summary>
/// Exposes <see cref="GridView"/> types to UI Automation.
/// </summary>
public class GridViewAutomationPeer : IViewAutomationPeer, ITableProvider
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GridViewAutomationPeer"/> class.
    /// </summary>
    /// <param name="owner">
    /// The <see cref="GridView"/> associated with this <see cref="GridViewAutomationPeer"/>.
    /// </param>
    /// <param name="listview">
    /// The <see cref="ListView"/> that the <see cref="GridView"/> is using as a view mode.
    /// </param>
    ...
    List<AutomationPeer> IViewAutomationPeer.GetChildren(List<AutomationPeer> children)
    {
        ...
        {
            AutomationPeer peer = FrameworkElementAutomationPeer.CreatePeerForElement(_owner.HeaderRowPresenter);
            if (peer != null)
            {
    ...
    {
        ListViewAutomationPeer lvAP = FrameworkElementAutomationPeer.FromElement(_listview) as ListViewAutomationPeer;
    ...
    {
        ListViewAutomationPeer peer = FrameworkElementAutomationPeer.FromElement(_listview) as ListViewAutomationPeer;
        if (peer != null)
        {
    ...
    IRawElementProviderSimple[] ITableProvider.GetColumnHeaders()
    {
        if (_owner.HeaderRowPresenter != null)
        {
            ...
            ListViewAutomationPeer lvpeer = FrameworkElementAutomationPeer.FromElement(_listview) as ListViewAutomationPeer;

            if (lvpeer != null)
            {
                foreach (UIElement e in _owner.HeaderRowPresenter.ActualColumnHeaders)
                {
                    AutomationPeer peer = FrameworkElementAutomationPeer.CreatePeerForElement(e);
                    if (peer != null)
                    {
#if OPENSILVER
                        array.Add(lvpeer.ProviderFromPeer(peer));
#else
    ...
    IRawElementProviderSimple IGridProvider.GetItem(int row, int column)
    {
        ...
        if (lvi == null)
        {
            ...
            itemsHost?.BringIndexIntoViewPublic(row);
        ...
        if (lvi != null)
        {
            AutomationPeer lvpeer = FrameworkElementAutomationPeer.FromElement(_listview);
            if (lvpeer != null)
            {
                AutomationPeer peer = FrameworkElementAutomationPeer.FromElement(lvi);
                if (peer != null)
                {
                    ...
                    {
#if OPENSILVER
                        return lvpeer.ProviderFromPeer(columns[column]);
#else
    ...
    internal static UIElement FindVisualByType(UIElement parent, Type type)
    {
        if (parent != null)
        {
            ...
            {
                UIElement visual = parent.InternalGetVisualChild(i);
