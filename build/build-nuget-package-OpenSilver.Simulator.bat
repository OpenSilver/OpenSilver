...
set /p PackageVersion="%ESC%[92mOpenSilver version:%ESC%[0m 2.0."
...
md temp
@echo OpenSilver.Simulator 2.0.%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
nuget.exe pack nuspec\OpenSilver.Simulator.nuspec -OutputDirectory "output/OpenSilver" -BasePath "%batDirectory%" -Properties "PackageVersion=2.0.%PackageVersion%;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
