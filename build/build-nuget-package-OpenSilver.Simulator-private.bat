...
md temp
@echo OpenSilver.Simulator 1.1.0-preview-%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
nuget.exe pack nuspec\OpenSilver.Simulator.nuspec -OutputDirectory "output/OpenSilver" -BasePath "%batDirectory%" -Properties "PackageVersion=1.1.0-preview-%PackageVersion%;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
