...
md temp
@echo OpenSilver 1.0.0-beta.1.%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver;PackageVersion=1.0.0-beta.1.%PackageVersion%;Configuration=SL;Target=OpenSilver"
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver.UWPCompatible;PackageVersion=1.0.0-beta.1.%PackageVersion%;Configuration=UWP;Target=OpenSilver.UwpCompatible"
