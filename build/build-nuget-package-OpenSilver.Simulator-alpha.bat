...
echo. 
msbuild -t:pack slnf/OpenSilver.Simulator.slnf -p:Configuration=SL -p:PackageOutputPath=%~dp0output/OpenSilver -p:NuspecFile=%~dp0nuspec/OpenSilver.Simulator.nuspec -p:NuspecBasePath=%~dp0 -p:NuspecProperties=PackageVersion=1.0.0-alpha-%PackageVersion%
