...
set /p PackageVersion="%ESC%[92mCSHTML5 version:%ESC%[0m 2.0.0-private"
...
echo. 
nuget.exe pack nuspec\CSHTML5.nuspec -OutputDirectory "output/CSHTML5" -Properties "PackageId=CSHTML5;;Target=CSHTML5;PackageVersion=2.0.0-private%PackageVersion%;Configuration=Debug;AssembliesPrefix=CSHTML5;CompilerPrefix=CSharpXamlForHtml5"
