...
set /p PackageVersion="%ESC%[92mOpenSilver version:%ESC%[0m 1.1."
...
md temp
@echo OpenSilver.Simulator 1.1.%PackageVersion% (%currentdate% %currenttime%)> temp/Version.txt
...
nuget.exe pack nuspec\OpenSilver.Simulator2.0.nuspec -OutputDirectory "output/OpenSilver" -BasePath "%batDirectory%" -Properties "PackageVersion=1.1.%PackageVersion%;RepositoryUrl=https://github.com/OpenSilver/OpenSilver"
