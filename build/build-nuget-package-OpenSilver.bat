...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver;PackageVersion=1.0.0-alpha-%PackageVersion%;Configuration=SL;AssembliesPrefix=OpenSilver"
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver.WorkInProgress;PackageVersion=1.0.0-alpha-%PackageVersion%;Configuration=SL.WorkInProgress;AssembliesPrefix=OpenSilver"
...
echo. 
nuget.exe pack nuspec\OpenSilver.nuspec -OutputDirectory "output/OpenSilver" -Properties "PackageId=OpenSilver.UWPCompatible;PackageVersion=1.0.0-alpha-%PackageVersion%;Configuration=UWP;AssembliesPrefix=OpenSilver.UWPCompatible"
